...
public class MainRunnableTeste {
    public static void main(String[] args) {
        ...
        MinhaThreadRunnable mtr1 = new MinhaThreadRunnable("Thread #1",600,sem);
...
//      Se for instanciar mais de uma classe, coloque no construtor se precisar.
        MinhaThreadRunnable mtr2 = new MinhaThreadRunnable("Thread #2",500,sem);
        MinhaThreadRunnable mtr3 = new MinhaThreadRunnable("Thread #3",800,sem);
